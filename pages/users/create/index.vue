...
<template>
    <NuxtLayout :name="layout">
        <div v-if="visibleAllow(4,2)" class="w-full px-3 mt-1">
            ...
            <div class="shadow-md bg-white w-full h-[calc(100vh-6rem)] overflow-hidden rounded-md">
                ...
                <div class="h-full overflow-y-auto w-full max-h-[calc(100vh-8.2rem)] flex flex-col bg-gray-100">
                    <div class="flex justify-center items-center w-full">
                        <form class="w-1/2" @submit.prevent="createCustomer" enctype="multipart/form-data">
                        <div class="grid grid-cols-2 gap-2 mt-4 p-4 rounded-md">
                            ...
                            <div>
                                ...
                                <input v-model="password" type="password" name="password" id="password" autocomplete="password" class="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            <div>
                                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Confirm Password</label>
                                <input v-model="password_confirmation" type="password" name="password_confirmation" id="password_confirmation" autocomplete="password_confirmation" class="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            <div class="w-full">
                                <label for="role" class="block text-sm font-medium text-gray-700">Role</label>
                                <Dropdown v-model="selectedRoles" :options="roles" optionLabel="name" optionValue="id" filter placeholder="Select a Role" class="w-full md:w-14rem p-2">
                            ...
                            <div class="w-full">
                                ...
                                <Dropdown v-model="selectedCountry" :options="country" optionLabel="name" optionValue="id" filter placeholder="Select a Country" class="w-full md:w-14rem p-2">
                                    <template #value="slotProps">
                                        <div v-if="slotProps.value" class="flex align-items-center">
